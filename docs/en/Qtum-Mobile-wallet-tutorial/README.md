...
Once all this is done, we're greeted with our Simplechain wallet.
...
Here we touch on the "+" sign on the left of our Simplechain address to display the QR code
