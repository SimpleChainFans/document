...
Una vez hecho todo esto, recibimos nuestra billetera Simplechain.
...
Aquí tocamos el signo "+" a la izquierda de nuestra dirección Simplechain para mostrar el código QR
